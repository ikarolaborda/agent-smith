...
func parseFlags() flags {
	...
	flag.StringVar(&f.researchSourcePublicKey, "research-source-bundle-public-key", "", "comma-separated trusted PEM Ed25519 public keys used to verify --research-source-bundles")
	...
	flag.StringVar(&f.researchApparatusPublicKey, "research-apparatus-public-key", "", "comma-separated trusted PEM Ed25519 public keys for apparatus admission")
